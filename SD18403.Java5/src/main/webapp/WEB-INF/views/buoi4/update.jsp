...
<form action="/buoi4/update" method="post">
    ...
    DiaChi: <input type="text" name="diaChi" value="${sinhVien.diaChi}"> <br>
    GioiTinh: <input type="radio" name="gioiTinh" value="true" ${sinhVien.gioiTinh ? "checked" : ""}> Nam
    <input type="radio" name="gioiTinh" value="false" ${sinhVien.gioiTinh ? "" : "checked"}> Nu
