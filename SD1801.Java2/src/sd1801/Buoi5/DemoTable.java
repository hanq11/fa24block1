...
public class DemoTable extends javax.swing.JFrame {
    ...
    public void initTableData() {
        DefaultTableModel model = (DefaultTableModel) tblHocSinh.getModel();
        model.addRow(new Object[]{1, "Nguyen Van A", null});
        model.addRow(new Object[]{2, "Nguyen Van B", 7.7});
        model.addRow(new Object[]{3, "Nguyen Van C", 8.7});
